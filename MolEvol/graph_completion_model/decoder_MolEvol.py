...
class GraphDecoder_ours(nn.Module):
    ...
    def __init__(self, avocab, rnn_type, embed_size, hidden_size, latent_size, depth):
        ...
        self.topo_loss = nn.BCEWithLogitsLoss(reduction='none')
        self.atom_loss = nn.CrossEntropyLoss(reduction='none')
        self.bond_loss = nn.CrossEntropyLoss(reduction='none')
    ...
    def decode(self, src_graph_vecs, init_mols, max_decode_step=80):
        ...
        graph_batch = IncGraph(self.avocab, batch_size, node_fdim=self.mpn.atom_size,
